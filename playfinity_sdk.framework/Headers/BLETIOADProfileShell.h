 ...
 *  \brief          Empty profile shell for starting OAD service
 *  \copyright      Copyright (c) 2013 Texas Instruments Inc.
 *  \file           BLETIOADProfileShell.h
 */
...
@interface BLETIOADProfileShell : BLEGenericProfile

@property CBService *service;
@property BLETIOADProfile *prof;
